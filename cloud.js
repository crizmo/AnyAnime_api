...
// const gif = "https://pfps.gg/assets/pfps/3401-idk.gif"
...
// instead of manually adding gifs read the test.json file and add the gifs to the database one by one
...
// ./database/data/test.json contains .jpg urls but i want them as .png so i will convert them to .png and add them to the database
// const jpgs = JSON.parse(fs.readFileSync("./database/data/test.json", "utf-8"));
// jpgs.forEach((jpg) => {
